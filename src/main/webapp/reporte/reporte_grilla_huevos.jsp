        ...
        <div class="card m-4">
            ...
            <section class="content" id="contenido"><div class="text-center">
                    <div class="card-header">
                        <h4 class="text-center">CONTADORES DE HUEVOS</h4>
                    </div>
                        <div class="card-header">
                        <form  id="filtro-form" class="form-inline" autocomplete="off">
                              <br><table class="table-responsive">
                                        ...
                                        <thead class="table-responsive" >
                                            ...
                                            <th><select id="avi" name="avi" class="form-control">
                                        ...
                                        <th><input type="date" id="idfecha" name="fecha" class="form-control text-center"></th>
                                        <th><input type="button" id="buscar" name="buscar" onclick="contador_h()" class="form-control text-center" value="Buscar"></th>
                        ...
                        <div class="card-header" id="datos">
                            ...
                            <div class="card-header">
                                <div class="text-center">
                                    ...
                                    <div class="text-center">
                                            <label>Huevos</label>
                                            <input type="text" value="0" id="huevos" name="huevos" class="form-control text-center border-huevos bg-huevos-light" disabled="">
                                    </div>
