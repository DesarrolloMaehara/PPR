...
<%   //conexion
    ...
    ResultSet rs;
    ps = con.prepareCall("select a.id as id_modulo,a.descripcion ,a.id_estado,b.descripcion as desc_estado from tab_mae_ppr_modulos a  "
            + "inner join tab_mae_ppr_estados b on a.id_estado=b.id inner join tab_mae_ppr_estados c on a.id_estado=c.id");
    rs = ps.executeQuery();

%>
<div class="container">
    <input  type="button" onclick="modalinsertmodulos()" id="crearrol" style="font-weight: bold;color:black;" class="btn btn-success" data-toggle="modal"   value="CREAR NUEVO MODULO" > 
                    ...
                    <div class="text-center"  >
                        <div  class="input-group">
                            <input  type="button"   class="btn btn-primary btnEditar" 
                                    value="Modificar" onclick="edit_modulos('<%=rs.getInt("id_modulo")%>',
