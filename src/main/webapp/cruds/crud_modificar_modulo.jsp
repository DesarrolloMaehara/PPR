...
<%    
    ...
    String id            = request.getParameter("txt_id_modulo");
    String descri        = request.getParameter("txt_decri_modulo");
    String estado      = request.getParameter("select_estado_modulo");
    ...
    { 
        ...
        CallableStatement  call;   
                call = clase.controles.connectSesion.prepareCall("{call [stp_mae_ppr_update_modulos](?,?,?,?,?)}");
